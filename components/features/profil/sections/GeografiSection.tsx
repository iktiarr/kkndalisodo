...
/**
 * Komponen GeografiSection
 * 
 * Menampilkan seksi letak geografis, batas wilayah 4 arah mata angin (Utara, Selatan, Timur, Barat),
 * aksesibilitas ke pusat kecamatan/kabupaten, serta informasi hidrologi dan cuaca Desa Dalisodo.
 *
 * @param {GeografiSectionProps} props - Properti komponen berisi data profil desa.
 * @returns {JSX.Element} Elemen seksi geografi dan batas wilayah.
 */
export default function GeografiSection({ data }: GeografiSectionProps) {
  return (
    <section id="geografi" className="scroll-mt-32 space-y-8">
      {/* Header Seksi Geografi */}
      ...
      {/* Batas Wilayah 4 Arah Mata Angin (Utara, Selatan, Timur, Barat) */}
      ...
      {/* Informasi Aksesibilitas & Hidrologi */}

import { PerangkatDesa } from "@/types/profil";

export const pemerintahanData: PerangkatDesa[] = [
  ...
  { id: "8", nama: "Kepala Dusun Wangkal", jabatan: "Kepala Dusun Wangkal" },
  { id: "9", nama: "Kepala Dusun Gandul", jabatan: "Kepala Dusun Gandul" },
  { id: "10", nama: "Kepala Dusun Sengon Utara", jabatan: "Kepala Dusun Sengon Utara" },
